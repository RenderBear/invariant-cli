...
def establishment_intent(focus: str = "") -> str:
    ...
    return (
        ...
        "interface, audit, command, and test locator must resolve in the exact candidate. Records "
        "carry no authority field; Invariant derives authority from the acceptance that lands them. Never "
